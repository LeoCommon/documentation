...
- Clone the [Hawkbit Project](https://github.com/LeoCommon/hawkbit) to get the code and follow the install instructions there. (Hawkbit is an external software, that we just use for updates. We do not claim being experts for this software.)
